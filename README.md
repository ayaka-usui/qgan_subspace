...
3. **Running**:
    ...
    - The only file you need to edit, for changing experiments, is `src/config.py`.ç

        *(This file also contains the documentation regarding the different QGANs you can run)*
